...
<p align="center">
  <img src="docs/assets/poster.png" alt="LS Panel — десктопний менеджер локального середовища розробки для PHP/веб-проєктів" width="800">
</p>

**LS Panel** — це десктопний менеджер локального середовища розробки для PHP/веб-проєктів. Працює як нативний застосунок (Tauri + React) і керує Docker/Podman-контейнерами, локальними базами даних, TLS-сертифікатами, перехопленням пошти, резервними копіями тощо через єдиний інтерфейс.
...
> ⚠️ **Статус: v0.6.0-beta.** LS Panel перебуває на ранній стадії активної розробки — можливі суттєві зміни та шорсткі кути.
...
**Розробка** — Сайти · Git · Контейнери · Бази даних · Файли середовища · Live-логи · Вбудований термінал
