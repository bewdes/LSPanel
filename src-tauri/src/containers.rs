...
fn compose(e: &Environment, sites_directory: &Path, sites: &[crate::sites::Site]) -> String {
    ...
    let app = if e.web_server == "Nginx" {
        format!("  web:\n    container_name: {}\n    image: docker.io/library/nginx:{}\n    volumes:\n      - {}\n      - ./default.conf:/etc/nginx/conf.d/default.conf:ro\n    depends_on: [php]\n    healthcheck:\n      test: [\"CMD\", \"wget\", \"-qO-\", \"http://127.0.0.1\"]\n      interval: 10s\n      timeout: 3s\n      retries: 5\n    networks:\n      default: {{}}\n      lspanel:\n        aliases: [\"lsp-{}\"]\n  php:\n    build:\n      context: .\n      dockerfile: Dockerfile.php\n{}{}    volumes: [{}]\n    depends_on: [database]\n    healthcheck:\n      test: [\"CMD\", \"php-fpm\", \"-t\"]\n      interval: 10s\n      timeout: 3s\n      retries: 5\n    networks:\n      default: {{}}\n      lspanel: {{}}\n", web_container_name, e.web_version, site_ro, e.id, custom_environment, xdebug_host, site_rw)
    } else {
        format!("  web:\n    container_name: {}\n    build:\n      context: .\n      dockerfile: Dockerfile.php\n{}{}    volumes:\n      - {}\n      - ./000-default.conf:/etc/apache2/sites-enabled/000-default.conf:ro\n    depends_on: [database]\n    healthcheck:\n      test: [\"CMD\", \"php\", \"-r\", \"exit(fsockopen('127.0.0.1', 80) ? 0 : 1);\"]\n      interval: 10s\n      timeout: 3s\n      retries: 5\n    networks:\n      default: {{}}\n      lspanel:\n        aliases: [\"lsp-{}\"]\n", web_container_name, custom_environment, xdebug_host, site_rw, e.id)
    };
    ...
    if e.extra_services.iter().any(|item| item == "node") {
        ...
        let working_dir = sites
            ...
            .map(|site| format!("/var/www/sites/{}", site.name))
            .unwrap_or_else(|| "/var/www/sites".into());
        extras.push_str(&format!("  node:\n    image: docker.io/library/node:{}-alpine\n    command: [\"sh\", \"-lc\", {}]\n    working_dir: {}\n{}{}    volumes: [{}]\n    healthcheck:\n      test: [\"CMD\", \"wget\", \"-qO-\", \"http://127.0.0.1:3000\"]\n      interval: 10s\n      timeout: 3s\n      retries: 10\n    networks:\n      default: {{}}\n      lspanel:\n        aliases: [\"lsp-{}-node\"]\n", e.node_version, startup, working_dir, inspector_environment, inspector_port, site_rw, e.id));
    }
    ...
    apply_runtime_defaults(format!("name: {}\nservices:\n{}  database:\n    container_name: {}\n    image: {}:{}\n    environment:\n      {}\n    volumes: [\"database_data:/var/lib/{}\"]\n    healthcheck:\n      test: {}\n      interval: 10s\n      timeout: 5s\n      retries: 10\n{}volumes:\n  database_data:\n{}networks:\n  default: {{}}\n  lspanel:\n    external: true\n", e.name, app, database_container_name, db_image, e.database_version, db_environment, if e.database == "PostgreSQL" { "postgresql/data" } else { "mysql" }, database_healthcheck, extras, redis_volume), e)
}
...
mod tests {
    ...
    fn nginx_compose_contains_services_and_project_path() {
        ...
        assert!(yaml.contains("aliases: [\"lsp-demo\"]"));
    ...
    fn php_cron_generates_a_dedicated_service_and_validates_schedule() {
        ...
        assert_eq!(yaml.matches("lspanel: {}").count(), 2, "both php and cron must join the lspanel network so they can reach sibling sites through the gateway");
